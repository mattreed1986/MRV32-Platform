module CM(
    clk, rst, tu, restu, ecall, sret, mret, tuwfi, rxinterrupt, tx_int_ack, dev_start_signal,
    dev_stop_signal, sdevram, sdrs, sdrd, sdws, sdwd, spp, ssp, srs, pc, bacm, stucsrpc, pcpi, ipc,
    mpi, rpi, scmcsi, scmcst, scmpc, jalr, cur, smi, spm, srm, crm, sri, spcr, spcrt, srpc, spca,
    sraa, srab, sar, scmr, srcm, srram, srr8, srr16, srr32, sramrs8, sramrs16, sramrs32, sramru8,
    sramru16, scsr, srcs, spcs, scsp, scmcs, csbmr, csbmi, csor, csori, csan, csrl, csani, smrar,
    scma, scmau, stupc, ALU_OP, CM_PC, IR_CM, REGS_CM, CM_REGS, REG_A, REG_B, REG_D, CM_ALU, ALU_CM,
    ...
    output reg tu, tuwfi, restu, ecall, sret, mret, sdrs, sdws, srs, pc, pcpi, mpi, rpi, ipc,
        sdevram, scmcsi, scmcst, scmpc, jalr, cur, spp, ssp, smi, spm, srm, crm, sri, spcr, spcrt,
        srpc, spca, sraa, srab, sar, scmr, srcm, srram, srr8, srr16, srr32, sramrs8, sramrs16,
        sramrs32, sramru8, sramru16, scsr, srcs, spcs, scsp, scmcs, csbmr, csbmi, csor, csori, csan,
        csrl, csani, smrar, scma, scmau, dev_start_signal;
    wire[31:0] instruction;
    reg[5:0] T;
    reg wfi_irq, wfi_dev, resT, pf, ri;
